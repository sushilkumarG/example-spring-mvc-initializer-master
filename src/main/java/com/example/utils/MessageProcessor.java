...
public class MessageProcessor {
    ...
    public ParsedSmsData parseMBData(String text) {
        ...
        Pattern datePatternLacs = Pattern.compile(MBPatterns.FLAT_WITH_BHK_PROJECT_PRICE_IN_LACS.getPattern());

        Matcher mLacs = datePatternLacs.matcher(text);

        Pattern datePatternCrs = Pattern.compile(MBPatterns.FLAT_WITH_BHK_PROJECT_PRICE_IN_CRS.getPattern());

        Matcher mCrs = datePatternCrs.matcher(text);

        Pattern datePattern = Pattern.compile(MBPatterns.FLAT_WITH_BHK_PROJECT_PRICE.getPattern());
