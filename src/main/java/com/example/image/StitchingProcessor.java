 ...
 * @author Peter Abeles
 */
public class StitchingProcessor {
     ...
     */
    public static <T extends ImageGray, FD extends TupleDesc> Homography2D_F64 computeTransform(
            T imageA,
            T imageB,
     ...
     * points.
     */
    private static <T extends ImageGray, FD extends TupleDesc> void describeImage(
            T image,
            DetectDescribePoint<T, FD> detDesc,
    ...
    public static <T extends ImageGray> BufferedImage stitch(BufferedImage imageA, BufferedImage imageB) {
        return stitch(imageA, imageB, GrayF32.class);
    }
     ...
     */
    public static <T extends ImageGray> BufferedImage stitch(
        ...
        // distant objects.
        ModelMatcher<Homography2D_F64, AssociatedPair> modelMatcher = FactoryMultiViewRobust.homographyRansac(
                null,
                new ConfigRansac(60, 3));
    ...
    public static BufferedImage renderStitching(BufferedImage imageA, BufferedImage imageB, Homography2D_F64 fromAtoB) {
        ...
        ImageDistort<Planar<GrayF32>, Planar<GrayF32>> distort = DistortSupport.createDistortPL(
                GrayF32.class,
                model,
                interp,
                false);
    ...
    public static void main(String args[]) throws IOException {
        ...
        imageA = UtilImageIO.loadImage(UtilIO
                .pathExample("/Users/harshit/Desktop/softwares/eclipse/Parser/images/3/image_1.jpg"));
        imageB = UtilImageIO.loadImage(UtilIO
                .pathExample("/Users/harshit/Desktop/softwares/eclipse/Parser/images/3/out.jpg"));
        BufferedImage output = stitch(imageA, imageB, GrayF32.class);
        File outputfile = new File("/Users/harshit/Desktop/softwares/eclipse/Parser/images/3/final_out.jpg");
        ImageIO.write(output, "jpg", outputfile);
        // imageA =
        // UtilImageIO.loadImage(UtilIO.pathExample("stitch/kayak_01.jpg"));
        // imageB =
        // UtilImageIO.loadImage(UtilIO.pathExample("stitch/kayak_03.jpg"));
        // stitch(imageA, imageB, GrayF32.class);
        // imageA =
        // UtilImageIO.loadImage(UtilIO.pathExample("scale/rainforest_01.jpg"));
        // imageB =
        // UtilImageIO.loadImage(UtilIO.pathExample("scale/rainforest_02.jpg"));
        // stitch(imageA, imageB, GrayF32.class);
    }
}